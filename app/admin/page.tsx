...
export default function AdminLoginPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store session info in sessionStorage for UI
      ...
      <div style={{minHeight:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
        <div style={{width:"100%",maxWidth:400,animation:"fadeUp .4s ease"}}>
          ...
          <div style={{textAlign:"center",marginBottom:32}}>
            ...
            <h1 style={{fontFamily:"'Playfair Display',serif",color:"white",fontSize:"1.8rem",fontWeight:800,lineHeight:1.2}}>
              UniMart Admin
            </h1>
          ...
          <div style={{background:"rgba(255,255,255,0.05)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:20,padding:"28px 24px",boxShadow:"0 24px 80px rgba(0,0,0,0.4)"}}>
            <form onSubmit={submit} style={{display:"flex",flexDirection:"column",gap:18}}>
              ...
              {/* Staff ID */}
              <div>
                <label style={{display:"block",fontSize:"0.7rem",fontWeight:700,color:"rgba(255,255,255,0.5)",letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:7}}>
                  Staff ID
                </label>
                <input
                  value={staffId}
                  ...
                  required
                  style={{width:"100%",padding:"12px 14px",background:"rgba(255,255,255,0.07)",border:"1.5px solid rgba(255,255,255,0.12)",borderRadius:12,color:"white",fontSize:"1rem",outline:"none",fontFamily:"monospace",letterSpacing:"0.08em",fontWeight:700}}
                />
              </div>
              ...
              <div>
                ...
                <div style={{position:"relative"}}>
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    style={{width:"100%",padding:"12px 44px 12px 14px",background:"rgba(255,255,255,0.07)",border:"1.5px solid rgba(255,255,255,0.12)",borderRadius:12,color:"white",fontSize:"1rem",outline:"none"}}
                  />
              ...
              {/* Error */}
              {error && (
                <div style={{background:"rgba(239,68,68,0.15)",border:"1px solid rgba(239,68,68,0.3)",borderRadius:10,padding:"9px 14px",color:"#fca5a5",fontSize:"0.82rem"}}>
                  {error}
                </div>
              )}
          ...
          <p style={{textAlign:"center",color:"rgba(255,255,255,0.2)",fontSize:"0.72rem",marginTop:20}}>
            UniMart Admin Portal · Lytrix Consult
          </p>
        </div>
      </div>
    </>
